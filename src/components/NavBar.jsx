...
const NavBar = ({onToggleSearch}) => {
  ...
  return (
    ...
    <ul className="flex items-center gap-6 px-5">
      <li className={linkClass}><Link to="/" className={linkClass}>Home</Link></li>
      <li className={linkClass}><Link to="/products">Products</Link></li>
      <li className={linkClass}><Link to="/loyalty">Loyalty</Link></li>
      <li>
